...
namespace Web.Tests
{
    ...
    public class RandomizationWebServiceTests
    {
        ...
        public void AssignJumpersToRounds()
        {
            ...
            var down1 = new Jumper { FirstName = "down1", JumpGroup = grp, RandomizedUpDown = UpDownFlag.DownJumper, NumberOfJumps = maxJumpCount--, JumperID = 201 };
            var down2 = new Jumper { FirstName = "down2", JumpGroup = grp, RandomizedUpDown = UpDownFlag.DownJumper, NumberOfJumps = maxJumpCount--, JumperID = 202 };
            var down3 = new Jumper { FirstName = "down3", JumpGroup = grp, RandomizedUpDown = UpDownFlag.DownJumper, NumberOfJumps = maxJumpCount--, JumperID = 203 };
            var down4 = new Jumper { FirstName = "down4", JumpGroup = grp, RandomizedUpDown = UpDownFlag.DownJumper, NumberOfJumps = maxJumpCount, JumperID = 204 };
            ...
            _roundList.AddRange(new List<Round> {round1, round2, round3, round4, round5});
